...
public class UserInterface
{
	...
	private void manageLinear()
	{
		String[] choices = { "Slope", "Y Intercept", "X Intercept", "X Coefficient",
				"Y Coefficient", "Constant", "X Coordinate", "Y Coordinate",
				"Is Linear Function?", "Compare", "Print Slope-Intercept", "Print Point-Slope",
				"Print Sandard", "Help", "Cancel" };
		int ans = JOptionPane.showOptionDialog(jay, "What do you want to do?",
				"Equation Maker v1.1: Linear Maker", JOptionPane.DEFAULT_OPTION,
				JOptionPane.QUESTION_MESSAGE, null, choices, choices[14]);
		switch (ans)
		{
			case 0:
				print("" + line.getSlope());
				break;
			case 1:
				print("" + line.getYIntercept());
				break;
			case 2:
				print("" + line.getXIntercept());
				break;
			case 3:
	...
	{
		String[] choices = { "X squared Coefficients", "X Coefficients", "Y Intercept",
				"Discriminent", "X Intercepts", "Vertex", "Symmetrical Point", "Compare",
				"Print Equation", "Help", "Cancel" };
		int ans = JOptionPane.showOptionDialog(jay, "What do you want to do?",
				"Equation Maker v1.1: Quadratic Maker", JOptionPane.DEFAULT_OPTION,
				JOptionPane.QUESTION_MESSAGE, null, choices, choices[10]);
		switch (ans)
		{
			case 0:
			...
			case 2:
				...
				break;
			case 3:
				print("" + parabola.discriminentBoolean());
				break;
			case 4:
				print("" + parabola.getXIntercepts());
				break;
			case 5:
				print("" + parabola.vertex());
				break;
			case 6:
				print("" + parabola.symmetricalPoint());
				break;
			case 7:
				if (quadraticEquals())
					print("The equations are equal.");
			...
			case 8:
				...
				break;
			case 9:
				print("The discriminent tells whether the equation has no x intercepts or at leaset one.\nThe symmetrical point is the point opposite from the y intercept across the vertex's axis.\nCompare ask sfor another Quadratic equation and returns if they are equal.");
				break;
			case 10:
				menu(1);
				break;
	...
	private void menu(int sentFrom)
	{
		...
		if (sentFrom != 0)
		{
			...
			if (ans == 1)
			{
				String[] options = { "Linear Equation", "Quadratic Equation", "Cancel" };
				int x;
				if (sentFrom == -1)
					x = 0;
				else
					x = 1;
				int ans2 = JOptionPane.showOptionDialog(jay, "Where do yo want to go?",
