...
public class QuadraticEquation
{
	...
	/**
	 * 
	 * this gets passed terms when the quadratic is in the form of y = axx + bx
	 * + c
	 * 
	 * a =1, b=1, c=0
	 */
	 ...
	 * 
	 * @param axx
	 *             the coefficient of the x^2 value
	 * 
	 * @param bx
	 *             the coefficient of the x value
	 * 
	 * @param c
	 *             the constant (y-intercept)
	 * 
	 * @throws IllegalArgumentException
	 *              (if axx is 0, the equation is not quadratic)
	 */
	public QuadraticEquation(double axx, double bx, double c) throws IllegalArgumentException
	{
		if (axx == 0)
	...
	/**
	 * 
	 * takes in two linear equations and multiplies them to form a quadratic
	 * equation
	 * 
	 * @param e1
	 *             the first LinearEquation
	 * 
	 * @param e2
	 *             the second LinearEquation
	 */
	public QuadraticEquation(LinearEquation e1, LinearEquation e2)
	{
	...
	/**
	 * 
	 * @return a Point2D.Double object, the first term is the coordinate of the
	 *         first x
	 * 
	 *         intercept coordinate the second term is the coordinate of the
	 *         second x
	 * 
	 ...
	 *         FF
	 */
	public Point2D.Double getXIntercepts() throws IllegalArgumentException
	{
	...
	public Point2D.Double symmetricalPoint()
	{
		...
		double x = vert.getX();
		x *= 2;
		Point2D.Double symPoint = new Point2D.Double(x, this.getYIntercept());
		return symPoint;
	}
