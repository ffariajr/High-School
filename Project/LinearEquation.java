...
public class LinearEquation
{
	 ...
	 * @param yIntercept	the y intercept of the equation
	 */
	 ...
	 * (y-y1 = slope(x-x1))
	 * 
	 * @param xCoordinate	the x coordinate in the point
	 * @param yCoordinate	the y coordinate in the point
	 * @param slope	the slope of the equation
	 */
	 ...
	 * 
	 * @param xCoef	the coefficient of x
	 * @param yCoef	the coefficient of y
	 * @param constant	the constant on the other side of the equation
	 */
	...
	/**
	 * @return the x intercept of the equation if the equation is not a constant function
	 */
	...
	/**
	 * @return the string representation of the equation in slope intercept format
	 */
	 ...
	 * would be returned
	 * 
	 * @param x (a fraction with numerator in x and denominator in y)
	 * @return a Point 
	 */
	...
	{
		if(this.slope == other.slope && this.thePoint.x == other.thePoint.x && this.thePoint.y == other.thePoint.y)
			return true;
		return false;
	}
}