...
/**
 * A hash set stores an unordered collection of
 * objects, using a hash table.
 */
public class HashSet extends AbstractSet
{
	 ...
	 * @param x
	 *             an object
	 * @return true if x is an element of this
	 *         set
	 */
	 ...
	 * @param x
	 *             an object
	 * @return true if x is a new object, false
	 *         if x was already in the set
	 */
	public boolean add(Object x)
	{
		...
		while (current != null)
		{
			if (current.data.equals(x)) return false; // Already
												// in
												// the
												// set
			current = current.next;
	 ...
	 * @param x
	 *             an object
	 * @return true if x was removed from this
	 *         set, false if x was not an element
	 *         of this set
	 */
	...
	{
		/**
		 * Constructs a hash set iterator that
	...
	public void debug()
	{
		for(int x = 0;x<buckets.length; x++)
		{
			...
			while(pail!=null)
			{
				System.out.print(pail.data.toString()+" ");
				pail = pail.next;
				if(pail==null)
					System.out.println();
			}
