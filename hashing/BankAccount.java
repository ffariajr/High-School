...
public class BankAccount
{
	...
	/**
	 * Gets the account number of this bank
	 * account.
	 * 
	...
	public boolean equals(Object other)
	{
		...
		return (accountNumber == another.getAccountNumber() && balance == another.getBalance());
	}
	
	public int hashCode()
	{
		return accountNumber*HASH+(new Double(balance)).hashCode()*HASH;
	}
}
